...
if (isset($_POST['sub'])) {
    ...
    if ($result->num_rows >0) {
        ...
        $insert_query = $connect->query("insert into services values ('1','$opd','$emergency','$antenatal_care','$postnatal_care','$intranatal_care','$newborn_care','$child_care','$family_plan','$service_24','$nutrition','$school_prgm','$rehabilitation')");
