                ...
                <div class="container-fluid">
                    <div class="row-md-12">
                        <div class="outer-w3-agile mt-3">
                            ...
                            <br>
                            <form action="php/pregnancy_details.php" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4 " style="padding: 20px">
                                        <label for="expert">Number of Expert Treatment</label>
                                        <input type="number" class="form-control" name="expert" >
                                    </div>
                                    <div class="form-group col-md-4" style="padding: 20px">
                                        <label for="doctor">Number of Doctor Treatment</label>
                                        <input type="number" class="form-control" name="doctor" >
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-4" style="padding: 20px">
                                        <label for="doctor">Number of SBA</label>
                                        <input type="number" class="form-control" name="sba">
                                    </div>
                                    <div class="form-group col-md-4" style="padding: 20px">
                                        <label for="doctor">Home Delivery</label>
                                        <input type="number" class="form-control" name="home">
                                    </div>
                                    <div class="form-group col-md-4" style="padding: 20px">
                                        <label for="doctor">Institutinal Delivery</label>
                                        <input type="number" class="form-control" name="inst">
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4" style="padding: 15px">
                                        <label for="doctor">Complicated Delivery</label>
                                        <input type="number" class="form-control" name="comp">
                                    </div>
                                    <div class="form-group col-md-4" style="padding: 15px">
                                    ...
                                    <div class="form-group col-md-4" style="padding: 15px">
                                        ...
                                        <input type="number" class="form-control" name="abort">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <input type="number" class="form-control" name="age3">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4 ">
                                        ...
                                        <input type="number" class="form-control" name="anc">
                                    </div>
                                    <div class="form-group col-md-4 ">
                                        <label>Number of Intranatal Care</label>
                                        <input type="number" class="form-control" name="inc">
                                    </div>
                                    <div class="form-group col-md-4 ">
                                        <label>Number of Postnatal Care</label>
                                        <input type="number" class="form-control" name="pnc">
                                    </div>
                                </div>
                        ...
                        <div class="outer-w3-agile mt-3">
                            ...
                            <table id="tab1" class="table table-bordered table-responsive">
                                ...
                                $result = $db->query("select * from pregnancy_details");
                                if ($result) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr><td>" . $row['pregnancy_count'] . "</td> <td>" . $row['no_expert_treatment'] . "</td><td>" . $row['no_doctor_treatment'] . "</td><td>" . $row['no_delivery_SBA'] . "</td><td>" . $row['no_home_delivery'] . "</td><td>" . $row['no_institutional_delivery'] . "</td><td>" . $row['no_complicated_delivery'] . "</td><td>" . $row['no_maternal_death'] . "</td><td>" . $row['no_abortion'] . "</td><td>". $row['no_antenatal'] . "</td><td>". $row['no_postnatal'] . "</td><td>". $row['no_intranatal'] . "</td><td>" . $row['age_group_15_25'] ."</td><td>" . $row['age_group_26_35'] . "</td><td>". $row['age_group_36_45'] . "</td></tr>";
                                    }
                                }
