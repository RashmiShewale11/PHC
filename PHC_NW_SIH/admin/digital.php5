...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark" style="background-color: #385fad">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="view_phc.php5"><b>View PHCs</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="news.php5"><b>News & Highlights</b></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="grievance.php5"><b>Grievance</b></a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown"
                   aria-haspopup="true"
