...
<div class="container-fluid mt-5">
    <center><h2 class="mb-5"><b>News and Highlights</b></h2></center>
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
  <?php   while($row = mysqli_fetch_array($result))
                { ?>
           <h4 style="font-variant-caps: all-petite-caps;color: #ff1a17"><b><?php echo $row["Display"]; ?></b></h4>
            <p><?php echo $row["descr"]; ?></p>
            <!-- <a><?php echo $row["File"]; ?></a> -->
            <font size="2px"><?php echo $row["expire_d"]; ?>
            </font>
            <hr class="hr">
<?php }?>
                   </div> 
