...
<head>
    ...
    <?php 
      ...
      $id=$_SESSION['user']; 
      $sql="select * from phcregister where PHCid='$id'";
                            ...
                            <div class="dropdown-menu drop-3">
                                <div class="profile d-flex mr-o">
                                    ...
                                    <div class="profile-r align-self-center">
                                        <h3 class="sub-title-w3-agileits"><?php echo $row->Mfirstname; echo " "; echo $row->Mlastname;?></h3>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
                        <h4 class="tittle-w3-agileits mb-4">Pie Chart for Statewise PHC available</h4>
                        <div id="chartdiv"></div>
                    </div>
                    <!--// Pie-chart -->
                </div>
