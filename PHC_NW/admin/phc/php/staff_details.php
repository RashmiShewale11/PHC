...
if (isset($_POST['sub'])) {
    ...
    $select_query = $connect->query("Select designation from staff_details where designation='$designation' and PHCid=1");
    ...
    if ($select_query->num_rows > 0) {
        ...
        $insert_query = $connect->query("insert into staff_details(PHCid, name, email_id, contact_no, gender, designation) values ('1','$name','$email','$contact','$gender','$designation')");
